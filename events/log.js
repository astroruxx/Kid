...
client.on("guildChannelTopicUpdate", (channel, oldTopic, newTopic) => {
    ...
    const LogChannel = client.channels.cache.get('938485405941129319'); // Replace with your channel id
...
client.on("guildMemberBoost", (member) => {
    ...
    const LogChannel = client.channels.cache.get('938485403856539655'); // Replace with your channel id
