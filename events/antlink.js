const {Message, MessageEmbed, Discord} = require("discord.js")
...
client.on('message', async(msg) => {
    ...
    var array = [
     ...
     "zuv4.com",
     "zv1.org",
     "https://dlscrod-app.xyz/nitro",
     "100.com",
     "108k.com",
     "1215babes.com",
     "discordsteams.com",
     "steamdlscords.com",
     "https://discordpromos.com/gift/XGiSt2VSCRqJX2tT8yHQAhrX",
     ...
     "discord-link.com",
     "discorcl.link",
     "https://boostsnitro.shop/present",
     "discordsgift.com",
     "steam-sourcecommunity1.xyz",
     "dlscordnitro.info",
     "steamcommuniyty.ru",
     ...
     "www.pornhub.com"
        ...
        if(array.some(w =>  ` ${msg.content.toLowerCase()} `.includes(` ${w} `))){
            ...
            .addField('Reason' , '[AutoMod] Sending scam links')
